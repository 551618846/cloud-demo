package com.example.mygateway.loadbalancer;
...
public class GrayLoadBalancer implements ReactorServiceInstanceLoadBalancer {
    ...
    private String getGrayVersion(Request request) {
        if (request.getContext() instanceof RequestDataContext lbContext) {
            return lbContext.getClientRequest().getHeaders().getFirst(GRAY_VERSION_HEADER);
        }
